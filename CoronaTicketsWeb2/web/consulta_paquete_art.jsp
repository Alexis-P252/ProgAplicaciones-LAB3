...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="d-flex">
                 <h3 class="me-5">Consulta de Paquete de Espectaculos</h3>
    ...
    <div class="row mt-5">
        <div class="col-10">
            ...
            <div class="div-lista ml-2">
                ...
                <select name= "selector"id="listaUsuario" class="form-select w-25" aria-label="Default select example">
                    ...
                    i++; 
                     ...
                     <button id="btn_mostrar_datos" type="submit"> Mostrar datos del paquete </button>
                </form>  
