...
<body>
    ...
    <%  
        ...
        String marcar = (String) request.getParameter("marcar");
        
        if(marcar.equals("si")){ // SE VA A MARCAR AL ESPECTACULO COMO FAVORITO 
            sis.AgregarFavorito(nickname, espectaculo);
                %>
            <div class="alert alert-success d-flex align-items-center" role="alert">
                    <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Success:"><use xlink:href="#check-circle-fill"/></svg>
                    <div>
                        Ahora este espectaculo forma parte de tus favoritos
                    </div>
            </div> <%
        }else{ // SE VA A DESMARCAR AL ESPECTACULO DE FAVORITOS 
            sis.EliminarFavorito(nickname, espectaculo);
            %>
            <div class="alert alert-success d-flex align-items-center" role="alert">
                    <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Success:"><use xlink:href="#check-circle-fill"/></svg>
                    <div>
                        Este espectaculo ya no forma parte de tus favoritos
                    </div>
            </div> <%
        }
        %>
