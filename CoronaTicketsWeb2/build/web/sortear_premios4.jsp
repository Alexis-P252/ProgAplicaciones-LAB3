...
<body>
    ...
    <%  
        ...
        String espectaculo = dtF.getEspectaculo();
        ...
        Date fecha_vencimiento = c.getTime();
        
        
        String desc_premio = dtEsp.getDesc_premio();
        int cant_premios = dtEsp.getCant_premios();
        
        String[] registrados = sis.listarEspectadoresxFuncion(funcion);
         // SORTEAMOS Y ELEGIMOS A LOS GANADORES
        String[] ganadores = sis.SortearPremios(registrados,cant_premios);
        
        
        sis.SortearFuncion(funcion,espectaculo,desc_premio,cant_premios,actual,fecha_vencimiento,ganadores); %>
        
        <div class="alert alert-success d-flex align-items-center" role="alert">
            <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Success:"><use xlink:href="#check-circle-fill"/></svg>
            <div>
                Se ha realizado el sorteo correctamente
            </div>
        </div>
